...
<head>
	<meta charset="utf-8">
	<title>Data Pengembalian Kunci</title>
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href=""><img src="<?=base_url()?>assets/img/head.png" alt=""></a>
...
<div class="container">
	...
	<img src="<?=base_url()?>assets/img/pengembalian.png" class="pengembalian">
	<br>
			...
			<tr>
				...
				<td><?php if ( $i['data_ruangan']=='Ada') {
					foreach ($ruangan as  $value) {
						if ($value['id_tbl_kembali']==$i['id_kembali']) {
